...
function wubi_date_translator(input, seg)
    ...
    if (input == "date") then
        ...
        date1 = Candidate("date", seg.start, seg._end, os.date("%Y-%m-%d"), "")
        date2 = Candidate("date", seg.start, seg._end, os.date("%Y/%m/%d"), "")
        date3 = Candidate("date", seg.start, seg._end, os.date("%Y年%m月%d日"), "")
        date4 = Candidate("date", seg.start, seg._end, os.date("%Y.%m.%d"), "")
        date5 = Candidate("date", seg.start, seg._end, os.date("%m-%d-%Y"), "")
        date1.quality = 100
        date2.quality = 100
        date3.quality = 100
        date4.quality = 100
